      ...
      <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
        <div class="mt-10 lg:mt-0">
          ...
          <p class="text-base dark:text-gray-400 mb-8">
            I have been working as a Junior software developer for 5+ months. <br />
            During my career I have worked on various types of projects with various technologies,
            but very often I feel that I am a beginner who  who just started coding. <br />
          </p>
         <p class="text-base dark:text-gray-400 mb-8">
            In 2021 I decided to start the journey of becoming a professional Software. Since then I have focused on
            <span class="text-amber-500 font-bold">PHP</span> and <span class="text-amber-500 font-bold">JavaScript</span>. <br />
            I have good experience in Laravel and React js. <br />
          </p>
          {{--
          <x-button-link href="https://youtube.com/timXperience" variant="red" target="_blank">
            View my channel
          </x-button-link> --}}
        </div>
      </div>
