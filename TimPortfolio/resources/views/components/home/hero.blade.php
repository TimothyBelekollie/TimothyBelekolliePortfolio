    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          ...
          >
            My Name is Timothy. <br/>
            I am the <span class="rounded-md text-amber-600">TimXperience</span>.
          </h1>
          <p class="text-base mb-8 max-w-[520px]">
            I am a developer with 5+ months of experience. <br/>
            I love to get involve with new technologies and learning things. 
            {{-- <a
              class="text-primary font-bold no-underline hover:underline underline-offset-2 decoration-2 decoration-primary"
              href="https://youtube.com/TimXperience" target="_blank">YouTube Channel</a>. <br> --}}
          </p>
